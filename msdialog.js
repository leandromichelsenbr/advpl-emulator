(function () {
  ...
  function highlightAdvPL(source) {
    ...
    source.replace(pattern, (match, _capture, offset) => {
      ...
      else if (/^(?:MSDialog|TWBrowse|FWMBrowse|AxCadastro|AAdd|LoadBitmap|GetResources|MsgInfo|MsgStop|MsgAlert|Alert|Space|AllTrim|StrTran|If)$/i.test(match)) kind = "function";
      else kind = "keyword";
